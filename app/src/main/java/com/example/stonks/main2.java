...
//                Toast.makeText(main2.this, "You have exceeded your groceries budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
    }
...
//            else{if(addd<Rentb){
//                Toast.makeText(main2.this, "You have exceeded your rent budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//            else{if(addd<Fuelb){
//                Toast.makeText(main2.this, "You have exceeded your fuel budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded electricity ent budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//            else{if(addd<Waterb){
//                Toast.makeText(main2.this, "You have exceeded your water budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded your education budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded your entertainment budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded your travel budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded your maintenance budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
...
//                Toast.makeText(main2.this, "You have exceeded your 'others' budget!", Toast.LENGTH_SHORT).show();
//            }
//            }
        }
        ...
        Add.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(main2.this, add.class);
        ...
        Addbudget.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main2.this, budget.class);
                startActivity(intent);
        ...
        piechart.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main2.this, Pie_chart.class);
                startActivity(intent);
        ...
        transactions.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(main2.this, ViewListContents.class);
                startActivity(intent);
